import {w as b, s as S, x as T, W as I, K as O} from "./index.05f6d0f6.js";
const f = [];
function U(e, t) {
    return {
...
var y;
const q = ((y = globalThis.__sveltekit_1q8xez9) == null ? void 0 : y.base) ?? "";
var w;
const L = ((w = globalThis.__sveltekit_1q8xez9) == null ? void 0 : w.assets) ?? q
  , N = "1690199041587"
...
function W(e, t) {
    ...
    const r = e instanceof SVGAElement ? e.target.baseVal : e.target
      , a = !n || !!r || K(n, t) || (e.getAttribute("rel") || "").split(/\s+/).includes("external")
...
export {$ as I, k as P, j as S, Y as a, W as b, X as c, D as d, q as e, G as f, C as g, B as h, K as i, H as j, V as k, U as r, F as s, p as w};
