import {o as De, a5 as ye} from "../chunks/index.05f6d0f6.js";
import {S as He, a as Je, I as V, g as Ce, f as Ve, b as we, c as le, s as M, d as Q, i as _e, e as J, P as qe, h as We} from "../chunks/singletons.9d9d4190.js";
function Xe(t, o) {
...
window.fetch = (t,o)=>((t instanceof Request ? t.method : (o == null ? void 0 : o.method) || "GET") !== "GET" && te.delete(Se(t)),
fe(t, o));
const te = new Map;
function it(t, o) {
    const u = Se(t, o)
...
function st(t, o, u) {
    if (te.size > 0) {
        const i = Se(t, u)
          , d = te.get(i);
        if (d) {
            if (performance.now() < d.ttl && ["default", "force-cache", "only-if-cached", void 0].includes(u == null ? void 0 : u.cache))
...
function lt(t) {
    const o = [];
    return {
        pattern: t === "/" ? /^\/$/ : new RegExp(`^${ut(t).map(i=>{
            const d = /^\[\.\.\.(\w+)(?:=(\w+))?\]$/.exec(i);
            if (d)
                return o.push({
                    name: d[1],
            ...
            return "/" + S.map((b,w)=>{
                if (w % 2) {
                    ...
                    if (b.startsWith("u+"))
                        return be(String.fromCharCode(...b.slice(2).split("-").map(P=>parseInt(P, 16))));
                    const p = ct.exec(b);
                    if (!p)
                        throw new Error(`Invalid param: ${b}. Params and matcher names can only have underscores and alphanumeric characters.`);
                    const [,D,x,k,N] = p;
                    return o.push({
                        name: k,
                        matcher: N,
...
function dt(t, o, u) {
    ...
    for (let S = 0; S < o.length; S += 1) {
        ...
        if (l.chained && l.rest && f) {
            i[l.name] = d.slice(S - f, S + 1).filter(w=>w).join("/"),
            f = 0;
            continue
        }
        if (b === void 0) {
...
function pt({nodes: t, server_loads: o, dictionary: u, matchers: i}) {
    ...
    return Object.entries(u).map(([l,[b,w,p]])=>{
        ...
        return k.errors.length = k.layouts.length = Math.max(k.errors.length, k.layouts.length),
        k
    }
    );
    function f(l) {
...
async function ht(t) {
    ...
    for (const u in t)
        if (typeof ((o = t[u]) == null ? void 0 : o.then) == "function")
            return Object.fromEntries(await Promise.all(Object.entries(t).map(async([i,d])=>[i, await d])));
    return t
}
const gt = -1
  , mt = -2
...
function Rt(t, o) {
    ...
    let p = {
        ...
        error: null,
        url: null
    }, D = !1, x = !1, k = !0, N = !1, P = !1, z = !1, B = !1, q, j = ($e = history.state) == null ? void 0 : $e[V];
    j || (j = Date.now(),
    ...
    const ue = K[j];
    ue && (history.scrollRestoration = "manual",
    scrollTo(ue.x, ue.y));
    let F, ne, ae;
    async function ke() {
        ae = ae || Promise.resolve(),
        await ae,
        ae = null;
        ...
        if (r === ne && a) {
            ...
            a.props.page !== void 0 && (F = a.props.page),
            q.$set(a.props)
        }
    }
    function Re(e) {
    ...
    async function re(e, {noScroll: n=!1, replaceState: r=!1, keepFocus: a=!1, state: s={}, invalidateAll: c=!1}, g, m) {
    ...
    async function Le(e) {
        return b = {
            id: e.id,
            promise: he(e).then(n=>(n.type === "loaded" && n.state.error && (b = null),
            n))
        },
        b.promise
    }
    ...
    function Oe(e) {
        ...
        w.after_navigate.forEach(s=>s(r)),
        x = !0
    }
    ...
    function Pe(e, n, r, a, s) {
        ...
        if (!a)
            return !1;
        if (a.parent && e || a.route && n || a.url && r)
            return !0;
        for (const c of a.params)
            if (s[c] !== p.params[c])
                return !0;
        for (const c of a.dependencies)
            if (S.some(g=>g(new URL(c))))
                return !0;
        return !1
    }
    function pe(e, n) {
    ...
    async function he({id: e, invalidating: n, url: r, params: a, route: s}) {
        ...
        const $ = v.map(async(E,L)=>{
            ...
            const I = p.branch[L]
              , T = h == null ? void 0 : h[L];
            if ((!T || T.type === "skip") && E[1] === (I == null ? void 0 : I.loader) && !Pe(U, A, R, (ge = I.universal) == null ? void 0 : ge.uses, a))
                return I;
            if (U = !0,
        ...
        for (let E = 0; E < v.length; E += 1)
            if (v[E])
                try {
                    ...
                    let I = 500, T;
                    if (h != null && h.includes(L))
                        I = L.status ?? I,
                        T = L.error;
                    else if (L instanceof ee)
                        I = L.status,
                        T = L.body;
                    else {
                        if (await M.updated.check())
                            return await G(r);
                        T = await X(L, {
                            params: a,
                            url: r,
    ...
    function xe({url: e, type: n, intent: r, delta: a}) {
        ...
        return P || w.before_navigate.forEach(y=>y(g)),
        s ? null : c
    }
    async function ce({url: e, scroll: n, keepfocus: r, redirect_chain: a, details: s, type: c, delta: g, nav_token: m={}, accepted: v, blocked: y}) {
        var $, C, E;
        const R = W(e, !1)
          , A = xe({
            url: e,
        ...
        if (_.type === "redirect")
            if (a.length > 10 || a.includes(e.pathname))
                ...
                return re(new URL(_.location,e).href, {}, [...a, e.pathname], m),
                !1;
        else
            (($ = _.props.page) == null ? void 0 : $.status) >= 400 && await M.updated.check() && await G(e);
        if (S.length = 0,
        B = !1,
        N = !0,
        ve(O),
        Re(O),
        (C = _.props.page) != null && C.url && _.props.page.url.pathname !== e.pathname && (e.pathname = (E = _.props.page) == null ? void 0 : E.url.pathname),
        s) {
    ...
    function Ye() {
        ...
        const r = new IntersectionObserver(c=>{
            for (const g of c)
                g.isIntersecting && (oe(se(new URL(g.target.href))),
                r.unobserve(g.target))
        }
        ,{
            threshold: 0
        });
        ...
        function s() {
            ...
            for (const c of f.querySelectorAll("a")) {
                ...
                if (m || v)
                    continue;
                const y = le(c);
                y.reload || (y.preload_code === qe.viewport && r.observe(c),
                y.preload_code === qe.eager && oe(se(g)))
            }
        }
        w.after_navigate.push(s),
        s()
    }
    function X(e, n) {
    ...
    return {
        ...
        preload_data: async e=>{
            const n = new URL(e,Ce(document))
              , r = W(n, !1);
            if (!r)
                throw new Error(`Attempted to preload a URL that does not belong to this app: ${n}`);
            await Le(r)
        }
        ,
        preload_code: oe,
        ...
        _start_router: ()=>{
            ...
            f.addEventListener("click", n=>{
                ...
                if (c === "_parent" || c === "_top") {
                    ...
                    return;
                const m = le(r);
                if (!(r instanceof SVGAElement) && a.protocol !== location.protocol && !(a.protocol === "https:" || a.protocol === "http:") || g)
                    return;
                if (s || m.reload) {
                    xe({
                        url: a,
        ...
        ,
        _hydrate: async({status: e=200, error: n, node_ids: r, params: a, route: s, data: c, form: g})=>{
            D = !0;
            ...
            try {
                const y = r.map(async(O,_)=>{
                    const h = c[_];
                    return h != null && h.uses && (h.uses = Ge(h.uses)),
                    de({
                        loader: t.nodes[O],
                        url: m,
                        params: a,
...
async function Be(t, o) {
    ...
    if (!i.ok)
        throw new ee(i.status,await i.json());
...
`);
                ...
                N.type === "redirect")
                    return d(N);
                if (N.type === "data")
                    (p = N.nodes) == null || p.forEach(P=>{
                        (P == null ? void 0 : P.type) === "data" && (P.uses = Ge(P.uses),
                        P.data = b(P.data))
                    }
                    ),
                    d(N);
    ...
    if (t)
        ...
        if (i && i.type !== "None") {
            ...
            for (let f = 0; f < i.rangeCount; f += 1)
                d.push(i.getRangeAt(f));
            setTimeout(()=>{
                if (i.rangeCount === d.length) {
                    for (let f = 0; f < i.rangeCount; f += 1) {
                        const S = d[f]
                          , l = i.getRangeAt(f);
                        if (S.commonAncestorContainer !== l.commonAncestorContainer || S.startContainer !== l.startContainer || S.endContainer !== l.endContainer || S.startOffset !== l.startOffset || S.endOffset !== l.endOffset)
                            return
                    }
                    i.removeAllRanges()
                }
